...
<%@ taglib prefix="tyb" uri="http://www.simon.com" %>
...
<head>
    ...
    <link href="/plugIn_web/dwz/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/plugIn_web/dwz/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/plugIn_web/dwz/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
    <link href="/plugIn_web/dwz/uploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
    <!--[if IE]>
    <link href="/plugIn_web/dwz/themes/css/ieHack.css" rel="stylesheet" type="text/css" media="screen"/>
    <![endif]-->

    <!--[if lt IE 9]><script src="/plugIn_web/dwz/js/speedup.js" type="text/javascript"></script>
<script src="/plugIn_web/dwz/js/jquery-1.11.3.min.js" type="text/javascript"></script><![endif]-->
    <!--[if gte IE 9]><!--><script src="/plugIn_web/dwz/js/jquery-2.1.4.min.js" type="text/javascript"></script><!--<![endif]-->

    <script src="/plugIn_web/dwz/js/jquery.cookie.js" type="text/javascript"></script>
    <script src="/plugIn_web/dwz/js/jquery.validate.js" type="text/javascript"></script>
    <script src="/plugIn_web/dwz/js/jquery.bgiframe.js" type="text/javascript"></script>
    <script src="/plugIn_web/dwz/xheditor/xheditor-1.2.2.min.js" type="text/javascript"></script>
    <script src="/plugIn_web/dwz/xheditor/xheditor_lang/zh-cn.js" type="text/javascript"></script>
    <script src="/plugIn_web/dwz/uploadify/scripts/jquery.uploadify.js" type="text/javascript"></script>

    <!-- svg图表  supports Firefox 3.0+, Safari 3.0+, Chrome 5.0+, Opera 9.5+ and Internet Explorer 6.0+ -->
    <script type="text/javascript" src="/plugIn_web/dwz/chart/raphael.js"></script>
    <script type="text/javascript" src="/plugIn_web/dwz/chart/g.raphael.js"></script>
    <script type="text/javascript" src="/plugIn_web/dwz/chart/g.bar.js"></script>
    <script type="text/javascript" src="/plugIn_web/dwz/chart/g.line.js"></script>
    <script type="text/javascript" src="/plugIn_web/dwz/chart/g.pie.js"></script>
    <script type="text/javascript" src="/plugIn_web/dwz/chart/g.dot.js"></script>

    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=6PYkS1eDz5pMnyfO0jvBNE0F"></script>
    <script type="text/javascript" src="http://api.map.baidu.com/library/Heatmap/2.0/src/Heatmap_min.js"></script>

     <script src="/plugIn_web/dwz/js/dwz.core.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.util.date.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.validate.method.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.barDrag.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.drag.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.tree.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.accordion.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.ui.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.theme.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.switchEnv.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.alertMsg.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.contextmenu.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.navTab.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.tab.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.resize.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.dialog.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.dialogDrag.js" type="text/javascript"></script>
     <%--<script src="/plugIn_web/dwz/js/dwz.sortDrag.js" type="text/javascript"></script>--%>
     <script src="/plugIn_web/sortDrag/jquery.dragsort-0.5.2.js" type="text/javascript"></script>

     <script src="/plugIn_web/dwz/js/dwz.cssTable.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.stable.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.taskBar.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.ajax.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.pagination.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.database.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.datepicker.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.effects.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.panel.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.checkbox.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.history.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.combox.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.file.js" type="text/javascript"></script>
     <script src="/plugIn_web/dwz/js/dwz.print.js" type="text/javascript"></script>

    <!-- 可以用dwz.min.js替换前面全部dwz.*.js (注意：替换时下面dwz.regional.zh.js还需要引入)-->
    <%--<script src="/plugIn_web/dwz/bin/dwz.min.js" type="text/javascript"></script>--%>
    ...
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="../../plugIn_web/ueditor/ueditor.all.min.js"></script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="../../plugIn_web/ueditor/lang/zh-cn/zh-cn.js"></script>
    <%--<script type=”text/javascript”>
        var UEDITOR_HOME_URL='../../plugIn_web/ueditor/',ueditor_loader={};
        //编辑器同步
    ...
    <script type="text/javascript">
        $(function(){
            DWZ.init("/plugIn_web/dwz/dwz.frag.xml", {
                loginUrl:"/login/reLogin", loginTitle:"登录",	// 弹出登录对话框
//		loginUrl:"login.html",	// 跳到登录页面
                ...
                callback:function(){
                    initEnv();
                    $("#themeList").theme({themeBase:"/plugIn_web/dwz/themes"}); // themeBase 相对于index页面的主题base路径
                }
            });
        });
    </script>
...
<div id="layout">
    <div id="header">
        <div class="headerNav">
            <ul class="nav">
                <li><a >${sessionScope.loginUser.userName}</a></li>
...
<div id="footer">Copyright &copy; 2017-8-11 TYB后台管理系统</div>
